...
// const Aboutme = React.forwardRef(id) => {
//   return (
//     <div
//       className="m-4 flex justify-center items-center flex-wrap md:h-screen"
//       id={id}>
...
const ScrollToButton = React.forwardRef(({ id }, ref) => (
  <React.Component ref={ref} id={id}>
    <div
      className="m-4 flex justify-center items-center flex-wrap md:h-screen"
      id={id}>
      <div className="md:w-1/2 flex justify-center items-center flex-col  my-10 md:my-0">
